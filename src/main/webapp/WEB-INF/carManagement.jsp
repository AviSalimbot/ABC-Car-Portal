...
<img src="images/covertwo.png" alt="CAR" style="width:100%;">
	...
	<div class="container my-5 py-5">
		...
		<h1 class="mb-5">Car Management</h1>
					...
					<tbody>
						<c:forEach items="${cars}" var="c" varStatus="status">
							<tr>
								...
								<!-- selling modal -->
								<td>${c.status}<!-- Button trigger modal -->
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<sf:form action="/sale_status?cid=${c.id}" method="post"
														...
														<div class="mb-3 mt-3">
															<label for="status" class="form-label">Sale
																Status:</label> <input type="text" class="form-control"
																placeholder="Enter sale status" name="status"
																value="${c.status}" required="true" />
															<div class="valid-feedback">Valid.</div>
															<div class="invalid-feedback">Please fill out this
																field.</div>
														</div>
